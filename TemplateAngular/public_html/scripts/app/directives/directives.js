        ...
        link: function (scope, element, attrs) {
            ...
            var smartActions = {
                ...
                userLogout: function ($this) {
                    ...
                    // ask verification
                    $.SmartMessageBox({
                        title: "<i class='fa fa-sign-out txt-color-White'></i> Desea salir <span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
                        content: $this.data('logout-msg') || "Para mayor seguridad después de salir cierre la ventana del navegador",
                        buttons: '[No][Si]'
